-- RESPOSTAS SLIDE 11 - Aula Junções
...
-- Liste todos os filmes e seus tickets vendidos Liste todos os filmes, seus diretores e os tickets vendidos 
...
SELECT *
FROM movies AS m RIGHT JOIN DIRECTOR AS d
